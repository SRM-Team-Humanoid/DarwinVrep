...
print(state)
angle = 5
errCode,motor2 = vrep.simxGetObjectHandle(CLIENT_ID,'j_tibia_l',vrep.simx_opmode_oneshot_wait)
vrep.simxSetJointTargetVelocity(CLIENT_ID,motor2,-angle,vrep.simx_opmode_oneshot_wait)
time.sleep(3)
state = getPos()
print(state)
